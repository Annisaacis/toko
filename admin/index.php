...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php?halaman=profile">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php?halaman=pembelian">
                    <i class="fas fa-fw fa-solid fa-bag-shopping"></i>
                    <span>Pembelian</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="index.php?halaman=laporan">
                    <i class="fas fa-fw fa-solid fa-file-text"></i>
                    <span>Laporan</span></a>
            </li>
            <li class="nav-item">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link" href="index.php?halaman=logout">
                    <i class="fa-fw fa-solid fa-arrow-right-from-bracket"></i>
                    <span>Logout</span></a>
            </li> -->
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="index.php?halaman=profile" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="container-fluid">
                    ...
                    if (isset($_GET["halaman"])) {
                        ...
                        } else if ($_GET["halaman"] == "stok") {
                            include "stok.php";
                        } else if ($_GET["halaman"] == "detail") {
                            include "detail.php";
                        } else if ($_GET["halaman"] == "add") {
                            include "tambah_produk.php";
                        } else if ($_GET["halaman"] == "edit_produk") {
                            include "edit_produk.php";
                        } else if ($_GET["halaman"] == "edit_pembelian") {
                            include "edit_pembelian.php";
                        } else if ($_GET["halaman"] == "tambah_stok") {
